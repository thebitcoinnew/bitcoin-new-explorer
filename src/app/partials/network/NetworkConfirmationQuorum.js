...
export default class NetworkConfirmationQuorum extends React.Component {
  ...
  stakeBelowMinumum() {
    const { peers_stake_total_mbtcnew, online_weight_minimum_mbtcnew } = this.state;

    return (
      parseFloat(peers_stake_total_mbtcnew, 10) <
      parseFloat(online_weight_minimum_mbtcnew, 10)
    );
  }

  render() {
    const {
      quorum_delta_mbtcnew,
      peers_stake_total_mbtcnew,
      online_weight_minimum_mbtcnew
    } = this.state;
      ...
      <div>
        ...
        {quorum_delta_mbtcnew === null ? (
          ...
          <div>
            ...
            >
              <FormattedNumber value={peers_stake_total_mbtcnew || 0} />{" "}
              ...
              <p className="text-danger">
                <TranslatedMessage
                  ...
                  values={{
                    ...
                    weight: (
                      <FormattedNumber
                        value={online_weight_minimum_mbtcnew || 0}
                      />
                    )
                  }}
                />
            ...
            <h5 className="mb-0">
              <FormattedNumber value={quorum_delta_mbtcnew || 0} />{" "}
              {config.currency.shortName}{" "}
